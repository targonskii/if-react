...
function Filter({ filterData, setFilterData }) {
  ...
  useEffect(() => {
    ...
    } else if (adults > filterDefault.adults.min || adults < filterDefault.adults.max) {
      setStateButtons({ ...stateButtons, minusAdults: false, plusAdults: false })
    }
  ...
  useEffect(() => {
    ...
    } else if (children > filterDefault.children.min || children < filterDefault.children.max) {
  ...
  useEffect(() => {
    ...
    } else if (rooms > filterDefault.rooms.min || rooms < filterDefault.rooms.max) {
    ...
    <div className="header__people_filter">
      <div className="header__people_adults">
        ...
        <div className="header__people_count">
          <button 
            className={(filterData.adults <= filterDefault.adults.min) ? 'header__people_disabled' : ''}
          ...
          <span className="adults" name="adults">{adults}</span>
          <button 
            className={(filterData.adults >= filterDefault.adults.max) ? 'header__people_disabled' : ''}
      ...
      <div className="header__people_children">
        ...
        <div className="header__people_count">
          <button 
            className={(filterData.children <= filterDefault.children.min) ? 'header__people_disabled' : ''}
          ...
          <button 
            className={(filterData.children >= filterDefault.children.max) ? 'header__people_disabled' : ''}
      ...
      <div className="header__people_rooms">
        ...
        <div className="header__people_count">
          <button 
            className={(filterData.rooms <= filterDefault.rooms.min) ? 'header__people_disabled' : ''}
          ...
          <span className="rooms" name="rooms">{rooms}</span>
          <button 
            className={(filterData.rooms >= filterDefault.rooms.max) ? 'header__people_disabled' : ''}
